/**
 * Bazzi-specific entry point
 *
 * This module provides metadata and functional API for Bazzi riwaya only.
 * Functions are pre-bound to riwayaLists for convenience and optimal tree-shaking.
 *
 * @example
 * ```typescript
 * import { meta, findJuz, getAyahMeta } from 'quran-meta/bazzi'
 *
...
import { BazziLists as riwayaLists } from "./lists/BazziLists"
import {
...
/**
 * Bazzi Lists (SurahList, JuzList, etc.)
 */
...
/**
 * Create a QuranRiwaya instance for Bazzi
 *
 * @example
 * ```typescript
 * import { createBazzi } from 'quran-meta/bazzi'
 *
 * const quran = createBazzi()
 * const ayahMeta = quran.getAyahMeta(1)
 * const juz = quran.findJuz(1, 1)
 * ```
 */
export const createBazzi = () => QuranRiwaya.create(riwayaLists)
