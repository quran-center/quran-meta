...
// Shuba and Hafs (both narrate from 'Asim) have identical SurahList, JuzList, HizbQuarterList, ManzilList, RukuList, SajdaList.
// They are shared instead of duplicated; `pnpm verify:lists` still checks them against
// the Shuba source data.
...
// ------------------ Surah Data ---------------------
export const SurahList: FixedArray<SurahInfo, 116> = HafsLists.SurahList
