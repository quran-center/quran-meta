/**
 * Sousi-specific entry point
 *
 * This module provides metadata and functional API for Sousi riwaya only.
 * Functions are pre-bound to riwayaLists for convenience and optimal tree-shaking.
 *
 * @example
 * ```typescript
 * import { meta, findJuz, getAyahMeta } from 'quran-meta/sousi'
 *
...
import { SousiLists as riwayaLists } from "./lists/SousiLists"
import {
...
/**
 * Sousi Lists (SurahList, JuzList, etc.)
 */
...
/**
 * Create a QuranRiwaya instance for Sousi
 *
 * @example
 * ```typescript
 * import { createSousi } from 'quran-meta/sousi'
 *
 * const quran = createSousi()
 * const ayahMeta = quran.getAyahMeta(1)
 * const juz = quran.findJuz(1, 1)
 * ```
 */
export const createSousi = () => QuranRiwaya.create(riwayaLists)
