...
function findJuzMetaBySurah(suraNumber) {
  var ayaNumber = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
...
function findJuzByAyaid(ayaId) {
  var _findSurahByAyaid = findSurahByAyaid(ayaId),
      ...
      s = _findSurahByAyaid2[0],
      a = _findSurahByAyaid2[1];
...
function pageMeta(pageNum) {
  var _ref = [Page[pageNum], Page[pageNum + 1]],
      curPage = _ref[0],
      nextPage = _ref[1];
  return {
    pageNum: pageNum,
    first: curPage,
    last: _toConsumableArray(findSurahByAyaid(findAyaidBySurah.apply(void 0, _toConsumableArray(nextPage)) - 1))
  };
}
/**
...
function pageMetaOld(pageNum) {
  var _ref2 = [Page[pageNum], Page[pageNum + 1]],
      curPage = _ref2[0],
      nextPage = _ref2[1];
  var _ref3 = [curPage[0], curPage[1], nextPage[1] === 1 ? nextPage[0] - 1 : nextPage[0], nextPage[1] === 1 ? Sura[nextPage[0] - 1][1] : nextPage[1] - 1],
      firstSurah = _ref3[0],
      firstAyah = _ref3[1],
      lastSurah = _ref3[2],
      lastAyah = _ref3[3];
    ...
    case "page":
      {
        ...
        return [findAyaidBySurah.apply(void 0, _toConsumableArray(Page[page])), findAyaidBySurah.apply(void 0, _toConsumableArray(Page[page + 1])) - 1];
      }
...
export { qdataHizb as HizbQuarter, Juz, Manzil, Page, qdataRuku as Ruku, Sajda, Sura, ayaStringSplitter, findAyaidBySurah, findJuz, findJuzByAyaid, findJuzMetaBySurah, findPage, findRangeAroundAyah, findSurahByAyaid, getAyaCountinSura, isAyahJuzFirst, meta, nextAyah, pageMeta, pageMetaOld, prevAyah };
