 ...
 * @param {*} ayaNumber
 */
function findJuz(suraNumber, ayaNumber = 1) {
    let l = 1;
...
function isAyahJuzFirst(suraNumber, ayaNumber) {
    return JuzList.findIndex((x) => x[0] == suraNumber && x[1] == ayaNumber);
}
 ...
 * @param {*} ayaNumber
 */
function findJuzMetaBySurah(suraNumber, ayaNumber = 1) {
...
function findPage(suraNumber, ayaNumber) {
    return (qdataPage.findIndex(x => (x[0] == suraNumber && x[1] > ayaNumber && x[1] > 1) ||
        x[0] > suraNumber) - 1);
}
/**
 *
...
function findRangeAroundAyah(surah, ayah, mode) {
    switch (mode) {
        ...
        case "page": {
            ...
            return [
                findAyaidBySurah(...qdataPage[page]),
                findAyaidBySurah(...qdataPage[page + 1]) - 1,
            ];
        }
        case "all":
        default:
